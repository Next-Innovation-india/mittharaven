...
const SEARCHES = [
  'melody itni chocolety kuv hai?',
  'motherfuckingwebsite.com',
  'ninja hattori',
  'doremon',
  'shizuka sexy wallpapers',
  'anime',
  'viruse',
  'pubg pro'
...
const PHRASES = [
  'Drake is a girl and she got a pink cat in between her legs',
  'war, blunt, pratham was a boy his male hen snached by a theif ',
  'Raven to mittha hai ',
  'Raven - baby aj mai ek naya ladka laya hu behind harsha slepping alone',
   'chaashni sa meethapan paye raven ke rago mein aaj hi ajmaye 20 rupees mein 2 ghante'
